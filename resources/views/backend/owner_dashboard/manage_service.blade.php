                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{route('owner_service.edit',['id'=>$service->id])}}" ><i class="far fa-edit"></i></a></td>
                                                <td><a href="{{route('owner_service.destroy',['id'=>$service->id])}}"><i class="cursor-pointer fas fa-trash text-secondary"></i></a></td>
